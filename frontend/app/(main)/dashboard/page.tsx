      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-blue-100/50 p-6 hover:shadow-md transition-shadow">
          ...
          <div className="space-y-4">
            {[
              { type: 'resolved', title: 'Pothole Repair', location: 'Vasant Vihar', time: '2h ago' },
              { type: 'active', title: 'Street Light Fix', location: 'Saket Metro Station', time: '4h ago' },
              { type: 'pending', title: 'Garbage Collection', location: 'Vasant Kunj', time: '6h ago' },
              { type: 'resolved', title: 'Water Leak', location: 'Iffco Chowk', time: '8h ago' },
              { type: 'active', title: 'Sidewalk Repair', location: 'Kalkaji Mandir', time: '10h ago' },
            ].map((activity, index) => (
